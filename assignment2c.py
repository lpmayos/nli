...
class Graph():
    ...
    def create_graph(self):
        ...
        graph.add_edge('meeting_pie', 'ask_username', required_words=['yes', 'please', 'sure'])
        ...
        graph.add_edge('explain_pie', 'ask_username', required_words=['yes', 'please', 'sure'])
        graph.add_edge('explain_pie', 'goodbye', required_words=['no', 'not', 'myself'])
        graph.add_edge('explain_pie', 'explain_pie', required_words=[])

        graph.add_edge('ask_username', 'ask_availability', required_words=[])
        graph.add_edge('ask_username', 'ask_username', required_words=[])

        graph.add_edge('ask_availability', 'ask_username', required_words=['no', 'mistake', 'error', 'wrong', 'sorry'])
    ...
    def parse_user_name(self, answer):
        """ finds the user name on teh answer, by deleting all the dummy words;
